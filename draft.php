...
<html lang="en">
    ...
    <body>
        ...
        <form action="./createpost.php" method="post">
            <label for="posttitle">Post title: </label><input autocomplete="off" type="text" maxlength="<?php echo intval($promptly_config["post"]["title"]["length"]["max"]); ?>" placeholder="Post title" name="posttitle"><br><br>
            <label for="posttext">Post text: </label><textarea style="width:100%;height:400px;" autocomplete="off" type="text" maxlength="<?php echo intval($promptly_config["post"]["body"]["length"]["max"]); ?>" placeholder="Post text" id="posttext" name="posttext"></textarea><br><br>
